...
const Bottom = () => {
    return(
        <div className="bottom">
            ...
            Currently at 127.0.0.1 :)
            </p>
            <div className="bottom-follow">
               <a rel="noreferrer" target="_blank" href="https://github.com/himakhaitan">Follow</a> 
            </div>
            ...
            <div className="bottom-contact">
                ...
                <div className="b-contact-element">
                    ...
                    <div><a rel="noreferrer" href="mailto:himanshukhaitan10@gmail.com" target="_blank">himanshukhaitan10@gmail.com</a></div>
                </div>
                <div className="b-contact-element">
                    <BiLink className="bottom-icon"/>
                    <div><a rel="noreferrer" href="https://dev.to/hima_khaitan" target="_blank">https://dev.to/hima_khaitan</a></div>
                </div>
                <div className="b-contact-element">
                    <FaTwitter className="bottom-icon"/>
                    <div><a rel="noreferrer" href="https://twitter.com/himanshukhaita4" target="_blank">@himanshukhaita4</a></div>
                </div>
                <div className="b-contact-element">
                    <FaLinkedinIn className="bottom-icon"/>
                    <div><a rel="noreferrer" href="https://www.linkedin.com/in/himanshu-khaitan-431666204/" target="_blank">Himanshu Khaitan</a></div>
                </div>
            </div>
        </div>
    )
